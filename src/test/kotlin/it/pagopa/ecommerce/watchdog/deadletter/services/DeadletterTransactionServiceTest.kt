...
class DeadletterTransactionServiceTest {
    ...
    fun `getDeadletterTransactions should return a ListDeadletterTransactions200ResponseDto with an element` () {
        ...
        val searchDeadLetterEventResponseDto : SearchDeadLetterEventResponseDto = SearchDeadLetterEventResponseDto()
        ...
        val searchTransactionResponseDto : SearchTransactionResponseDto = SearchTransactionResponseDto()
        ...
        whenever(nodoTechnicalSupportClient.searchNodoGivenNoticeNumberAndFiscalCode(any(), any(), any(), any()))
            .thenReturn(Mono.just(TransactionResponseDto()))



        StepVerifier.create(deadletterTransactionsService.getDeadletterTransactions(date, pageNumber, pageSize,))
        ...
        verify(ecommerceHelpdeskServiceV1).getDeadletterTransactionsByFilter(date, pageSize, pageNumber)
